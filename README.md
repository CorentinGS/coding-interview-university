...
- [x] Merge sort code:
    - [x] [Golang using parallel](https://github.com/CorentinGS/golang-exercices/tree/main/sort/mergesort)
    - [x] [C](https://github.com/CorentinGS/ds-exercices/blob/main/src/sort/merge_sort.c)
